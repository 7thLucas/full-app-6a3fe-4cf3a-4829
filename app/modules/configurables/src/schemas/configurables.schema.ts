...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    {
      fieldName: "dailyPostingTime",
      type: "string",
      required: false,
      label: "Default Daily Posting Time (HH:MM)",
    },
    {
      fieldName: "maxProductsInCatalog",
      type: "number",
      required: false,
    ...
    {
      fieldName: "enableAutoPosting",
      type: "boolean",
      required: false,
      label: "Enable Auto Posting",
    },
    {
      fieldName: "postCaptionTemplate",
      type: "string",
      required: false,
      label: "Post Caption Template",
    },
    {
