...
import postpilotProductRoutes from "./app/postpilot/routes/products.routes";
import postpilotPlatformRoutes from "./app/postpilot/routes/platforms.routes";
import postpilotScheduleRoutes from "./app/postpilot/routes/schedule.routes";
import postpilotHistoryRoutes from "./app/postpilot/routes/history.routes";
import { runSeeds } from "~/api/seeds";
import { startScheduler } from "./app/postpilot/utils/scheduler";
import { seedPostPilot } from "./app/postpilot/seeds/postpilot.seed";
...
async function startServer() {
  ...
  try {
    ...
    // Start PostPilot background scheduler
    startScheduler();
  ...
  // PostPilot API routes
  app.use(postpilotProductRoutes);
  app.use(postpilotPlatformRoutes);
  app.use(postpilotScheduleRoutes);
  app.use(postpilotHistoryRoutes);
